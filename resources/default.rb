resource_name :encrypted_volume

property :volume, String, required: true
property :mount_point, String, name_property: true, required: true
property :fstype, String, default: 'ext2'
property :mount_options, String, default: 'rw'

property :mode, Symbol, default: :normal, equal_to: [:normal, :onetime]

property :vault, String
property :vault_tag, String
...
action_class.class_eval do
  ...
  def crypt_device_exists?
    ::File.exists?(mapped_path)
  end
